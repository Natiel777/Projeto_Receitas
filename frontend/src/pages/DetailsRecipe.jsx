...
function DetalhesReceita() {
  ...
  const editarAvaliacao = async (idAvaliacao) => {
    ...
    try {
      await fetchAPI(`avaliacoes/${idAvaliacao}`, "PUT", {
        nota: notaEditada,
      });
      setAvaliacoes(await fetchAPI(`avaliacoes/receita/${id}`));
  ...
  return (
    <div className="max-w-3xl w-full mx-auto px-4 sm:px-6 py-8 font-sans dark:bg-neutral-800">
      ...
      <div className="bg-white dark:bg-neutral-700 p-5 sm:p-8 rounded-xl shadow-lg">
