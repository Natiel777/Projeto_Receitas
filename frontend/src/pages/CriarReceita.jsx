...
import { Botao, Input, TextArea } from "../ui/ui";
    ...
    <div className="max-w-md mx-auto mt-10 px-6 py-8 rounded-lg shadow-lg bg-white dark:bg-neutral-700 transition-colors duration-500 font-sans">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <Input
          ...
          required
          className="w-full px-4 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-neutral-600 text-gray-900 dark:text-white placeholder-neutral-600 dark:placeholder-neutral-600 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all duration-300"
        />
        <Input
          label="Categoria"
          value={categoria}
