          ...
          isButton ? (
            <li key={i}>
              <button
                ...
                className="block w-full text-left text-red-500 hover:text-red-500"
              >
                {label}
              </button>
            </li>
      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-3 relative">
          ...
          <div className="relative" ref={menuRef}>
            ...
            {menuAberto && (
              <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-black rounded-lg shadow-lg p-4 z-10">
                {renderLinks()}
              </div>
            )}
          </div>
