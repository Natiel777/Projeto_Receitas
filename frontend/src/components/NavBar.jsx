    ...
    <ul className="space-y-2 text-base font-medium text-black-900 dark:text-gray-100">
      ...
      <li>
        <button
          ...
          className="flex items-center gap-2 mt-2 w-full text-left p-2 bg-gray-50 dark:bg-neutral-700 rounded hover:bg-gray-100 dark:hover:bg-neutral-700 transition"
        >
